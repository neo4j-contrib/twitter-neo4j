...
from libs.cypher_store import DMCheckCypherStoreIntf as StoreIntf
...
class DMCheckBucketManager:
    ...
    def __init__(self):
        ...
        self.service_manager = ServiceManager(service_id=ServiceManagementIntf.ServiceIDs.DMCHECK_SERVICE)
